        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: BSizes.spaceBtwItems),
              Text('cara@itu.edu.pk', style: Theme.of(context).textTheme.labelLarge, textAlign: TextAlign.center),
              const SizedBox(height: BSizes.spaceBtwItems),
              ...
              const SizedBox(height: BSizes.spaceBtwItems),
              SizedBox(width: double.infinity, child: TextButton(onPressed: (){}, child: const Text(BTexts.resendEmail,style: TextStyle(color: BColors.primary),))),
              const SizedBox(height: BSizes.spaceBtwItems),
            ],
          ),
        ),
